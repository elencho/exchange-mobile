...
import {
	...
	verifyAccount,
	verifyPhoneNumber,
} from '@app/utils/userProfileUtils'
import {
...
// 	const { navigation } = action
// 	const userAndPassInfo = yield select((state) => state.profile.userAndPassInfo)
...
export default function* () {
	...
	yield takeLatest(actionTypes.START_REGISTRATION_ACTION, startRegistrationSaga)
	...
	yield takeLatest(actionTypes.CREDENTIALS_FOR_GOOGLE, credentialsForGoogleSaga)
