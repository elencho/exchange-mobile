...
import EmailLoginAuth from '@app/assets/images/User_profile/EmailLoginAuth.svg'
import SmsAuth from '@app/assets/images/User_profile/Sms_Auth.svg'
import TotpAuth from '@app/assets/images/User_profile/Totp_Auth.svg'
...
export default function Login2Fa({ navigation }) {
	...
	const {
		profile: { timerVisible },
		transactions: { loading },
		authReducer: { userAndPassInfo },
	} = state
